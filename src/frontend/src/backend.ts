...
export class Backend implements backendInterface {
    ...
    async createBookPlan(arg0: string, arg1: string, arg2: bigint, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createBookPlan(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllPlans(): Promise<Array<BookPlan>> {
        if (this.processError) {
            try {
    ...
    async getPlan(arg0: bigint): Promise<BookPlan> {
        if (this.processError) {
            try {
